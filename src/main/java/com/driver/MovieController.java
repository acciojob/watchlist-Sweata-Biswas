...
public class MovieController {
    ...
    public ResponseEntity<String> getDirectorByMovieName(@RequestParam("name") String movieName){
        return new ResponseEntity<>(movieService.getDirectorByMovieName(movieName),HttpStatus.OK);
    }
